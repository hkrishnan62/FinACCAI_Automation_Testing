...
public final class ActivityPrivacyPolicyBinding implements ViewBinding {
  ...
  private ActivityPrivacyPolicyBinding(@NonNull LinearLayout rootView, @NonNull WebView webview) {
  ...
  public static ActivityPrivacyPolicyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPrivacyPolicyBinding((LinearLayout) rootView, webview);
    }
