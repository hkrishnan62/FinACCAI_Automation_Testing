...
public final class ItemReportBinding implements ViewBinding {
  ...
  private ItemReportBinding(@NonNull MaterialCardView rootView, @NonNull TextView meta,
  ...
  public static ItemReportBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemReportBinding((MaterialCardView) rootView, meta, subtitle, title);
    }
