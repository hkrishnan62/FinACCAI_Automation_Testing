...
) : ListAdapter<ReportEntry, ReportAdapter.ReportViewHolder>(ReportDiffCallback()) {
...
class ReportDiffCallback : DiffUtil.ItemCallback<ReportEntry>() {
    override fun areItemsTheSame(oldItem: ReportEntry, newItem: ReportEntry): Boolean {
        return oldItem.reportUrl == newItem.reportUrl
    }

    override fun areContentsTheSame(oldItem: ReportEntry, newItem: ReportEntry): Boolean {
