...
object Prefs {
    ...
    fun loadHistory(context: Context): List<ReportEntry> {
    ...
    fun saveHistory(context: Context, history: List<ReportEntry>) {
        val arr = JSONArray()
    ...
    fun addHistoryEntry(context: Context, entry: ReportEntry, limit: Int = 20) {
